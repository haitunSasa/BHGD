...
import com.util.base.HqlFilter;
...
public class BaseServiceImpl<T> implements BaseServiceI<T> {
	...
	@Override
	public List<T> getByTagId(int id,String tagName) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(tagName, id);
		Class<T> c = (Class<T>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0];
		String hql = "from "+c.getSimpleName()+" t where "+tagName+" =:"+tagName;
		return baseDao.find(hql, params);
	}

	@Override
	public List<T> getByTagString(String tagValue, String tagName) {
		Map<String, Object> params = new HashMap<String, Object>();
